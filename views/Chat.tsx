...
export const Chat: React.FC = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // Note: In a real app, we would manage full chat history object for the API
      // Here we just send the last prompt with instructions for simplicity in this demo, 
